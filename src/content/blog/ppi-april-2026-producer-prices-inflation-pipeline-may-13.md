---
title: "April PPI Report Lands May 13 — Producer Prices Hold the Key to Inflation's Next Move"
description: "The April Producer Price Index drops on May 13 with energy costs and tariff effects front and center. After CPI's 3.8% surprise, wholesale inflation data will shape the Fed's rate path."
pubDate: "2026-05-13"
...
| Stage | Recent Trend | Implication |
|-------|-------------|-------------|
| Crude materials | Rising sharply (oil, metals) | Cost pressure entering the system |
| Intermediate goods | Rising moderately | Processing costs increasing |
| Finished goods | Mixed (March was cool) | Pass-through still uncertain |
| Consumer prices | Accelerating (CPI 3.8%) | End of the pipeline is hot |
...
The [90-day US-China trade truce](/blog/us-china-trade-truce-tariff-reduction-may-2026) announced on May 12 reduces US tariffs on Chinese goods from their prior layered rate to a flat 30%. That is a meaningful reduction — but 30% is still far above the pre-trade-war baseline. And the tariff reduction was announced on May 12, meaning it was not in effect during the April measurement period.
...
**In-line PPI (headline +0.4-0.5%)**: The muddled middle. Enough to keep inflation fears alive, not enough to trigger panic. Markets likely trade sideways as attention shifts to the [Trump-Xi summit](/blog/trump-xi-beijing-summit-may-14-15-trade-iran-2026) on May 14-15.

Whatever the number, the PPI report is one data point in a week that will define the near-term trajectory of markets, policy, and the US-China relationship. By Friday, investors will also have the results of the Beijing summit, the [Warsh confirmation](/blog/warsh-fed-chair-senate-vote-powell-exits-may-15-2026) as Fed chair, and Michigan consumer sentiment data. The volatility is not going away anytime soon.
