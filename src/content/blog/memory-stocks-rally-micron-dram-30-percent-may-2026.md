---
title: "Memory Chip Stocks Explode: Micron Up 14%, DRAM ETF Surges 30% in One Week"
description: "Memory semiconductor stocks posted their best week in years as DRAM prices spiked on AI server demand and supply constraints. Micron gained 13.7%, SanDisk rose 14.3%, and the DRAM-focused ETF surged roughly 30% in a single week."
pubDate: "2026-05-11"
...
| Stock / ETF | Weekly Gain | Primary Exposure |
|-------------|-------------|-----------------|
...
Nvidia's demand for HBM3e chips — used in both the H200 and B200 GPU platforms — is the single largest demand driver for the memory industry in 2026. The company's recent commitments to AI infrastructure, including [over $40 billion in equity investments across AI companies and data center operators](/blog/nvidia-40b-ai-equity-investments-openai-corning-2026/), signal that GPU production and by extension HBM consumption will continue scaling for multiple years.
...
[TSMC's Q1 2026 results](/blog/tsmc-q1-2026-earnings-ai-chip-demand/), which showed 58% profit growth driven by AI chip demand, reinforce the thesis that the current spending cycle is still in its expansion phase. TSMC manufactures the logic chips that consume HBM, so its order book provides a forward-looking signal for memory demand.
...
- [2 AI Stocks Beating Nvidia in 2026: Micron Is Up 59%, TSMC Reports 41% Revenue Growth](/blog/ai-stocks-micron-tsmc-outperforming-nvidia-2026/)
- [TSMC Q1 Profit Surges 58% on Record AI Chip Demand](/blog/tsmc-q1-2026-earnings-ai-chip-demand/)
- [ARM Stock Up 84% in 2026: What Q4 Earnings Mean for the AI Chip Rally](/blog/arm-holdings-q4-fy2026-earnings-ai-chip-rally-84-percent/)
- [Nvidia Has Committed Over $40 Billion in AI Equity Deals in 2026](/blog/nvidia-40b-ai-equity-investments-openai-corning-2026/)

*Sources: TrendForce, Bloomberg, Micron Technology Investor Relations, SK Hynix, Samsung Electronics, TSMC*
