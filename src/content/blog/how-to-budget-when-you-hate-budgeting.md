...
Understanding these barriers is the first step to finding a method that actually sticks. If you've fallen into [common budgeting mistakes](/blog/budgeting-mistakes-to-avoid/) before, it might be the system's fault, not yours.
...
**How it works:**
1. Decide on a savings percentage (start with 20%)
2. Set up automatic transfers on payday to savings/investment accounts
3. Spend whatever is left --- freely, guilt-free, on anything you want
...
The [50-30-20 rule](/blog/50-30-20-budget-rule-notion/) breaks your income into just three buckets:
...
1. **Payday:** Paycheck hits checking account
2. **Same day (auto):** Savings transfer, investment contribution, bill payments
3. **Next day (auto):** Weekly spending allowance transferred to spending account
4. **You:** Live your life. Check your spending account balance occasionally.
...
1. Pull up your bank/credit card statement
2. Highlight the 3 largest non-essential purchases
3. Ask: "Would I buy this again?" If no, that's your target for next month.
4. Redirect that amount to savings
...
The [New Life Starter Kit ($3.99)](https://gettidyflow.gumroad.com/l/new-life-starter-kit) is designed for exactly this approach --- a clean, simple Notion template that organizes your finances without overwhelming you with categories and trackers. Set it up once, automate the essentials, and forget about it.
