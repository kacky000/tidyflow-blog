...
Your regular budget no longer applies. You need a stripped-down emergency budget that covers only what's essential. If you've never built a budget before, our guide on [how to create a budget](/blog/how-to-create-a-budget/) covers the fundamentals.
...
Having an [emergency fund](/blog/emergency-fund-budget-template/) before job loss is ideal, but even if you didn't have one, these resources can fill the gap.
