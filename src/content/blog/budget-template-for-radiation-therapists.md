...
**Debt priority order:**
1. Credit cards (typically 18–28% APR)
2. Private student loans (variable rate, often 5–10%)
3. Federal student loans (fixed, often 5–7%)
4. Retirement savings (once high-rate debt is cleared)
...
For a broader look at how healthcare professionals approach budgeting — especially those managing shift work and irregular pay — see our guide on [budget templates for healthcare workers](/blog/budget-template-for-healthcare-workers/).

Radiation therapists and nurses share many financial challenges: shift differentials, overtime variation, and employer-based benefits packages. The [budget template for nurses](/blog/budget-template-for-nurses/) covers shift-work budgeting strategies in detail and applies directly to radiation therapy settings.
...
The **[Freelancer Expense Tracker](https://gettidyflow.gumroad.com/l/freelancer-expense-tracker)** ($9.99) is a powerful Excel-based tool that tracks variable income sources, categorizes expenses, and shows you exactly where your money goes each month. Perfect for radiation therapists managing base pay, shift differentials, and professional costs in one organized view.
