...
Check off each bill as you pay it. This simple habit eliminates late fees and the stress of wondering "did I pay that already?" If you're dealing with credit card debt on top of monthly bills, our [guide to budgeting with credit card debt](/blog/how-to-budget-with-credit-card-debt/) shows how to balance payments.

### List Expected Income

Write down every paycheck or payment you expect this month. For irregular income (freelance, side hustle), use your average from the past 3 months. If you're a freelancer, our [freelancer budget template](/blog/budget-template-for-freelancers/) handles variable income specifically.
...
Don't make this complicated. "I have $800 for groceries and fun stuff" is a perfectly valid budget. For a more structured approach, the [50/30/20 budget rule](/blog/50-30-20-budget-rule-notion/) gives you a simple framework: 50% for needs (bills), 30% for wants, and 20% for savings.

### Check for Irregular Bills and Expenses

Is anything unusual coming up? Car registration renewal? Annual software subscription? Birthday gifts? These irregular bills catch most people off guard. Add them to your **bills checklist** so they don't surprise you. A [sinking fund tracker](/blog/sinking-fund-tracker-template/) helps you save for these expenses in advance.
...
This is the single most important habit in personal finance. If you do nothing else on this monthly bills checklist, do this. For a detailed system, see [how to track expenses in Notion](/blog/how-to-track-expenses-in-notion/).
...
Again, not a deep analysis. Just a quick pulse check to make sure no bills are slipping through. If you find you're consistently overspending, our [how to stick to a budget](/blog/how-to-stick-to-a-budget/) guide has practical tips.
...
Add up everything you spent this month, grouped by category. Most expense trackers do this automatically. Check whether your subscription costs are creeping up with a quick [subscription audit](/blog/monthly-subscription-audit-template/).
...
Income minus total bills and expenses equals savings (or overspending). Write this number down. Track it month to month. If you're working to build savings, check out [how to save money as a college student](/blog/how-to-save-money-college-student/) — the tips work for anyone on a tight budget.
...
Based on what you learned, set next month's numbers. Small adjustments, not dramatic changes. Copy your bills checklist forward and update any amounts that changed. If you're looking for a digital tool to streamline this process, see our [best Notion budget templates for 2026](/blog/best-notion-budget-templates-2026/) — they handle categories, tracking, and monthly reviews in one workspace.
...
- **Homeowners**: Mortgage, property tax, maintenance fund. A [home renovation budget](/blog/budget-for-home-renovation/) helps when big projects come up.
- **Retirees**: Fixed income, Medicare, adjusted bills. Our [retirement budget checklist](/blog/retirement-budget-checklist/) is built for this stage.
- **Couples**: Combining bills and budgets. See [budgeting for couples](/blog/budgeting-for-couples/) for how to merge your bills checklists.
...
Use Excel or Google Sheets for automatic calculations and running totals. See our [best budget spreadsheet templates](/blog/best-budget-spreadsheet-templates/) for ready-made options.

### Notion Checklist
If you already use Notion for task management, keeping your bills checklist there makes sense. It's always with you on your phone. Our [Notion vs Excel budgeting comparison](/blog/notion-vs-excel-budgeting/) helps you decide which tool fits your style.
...
For more budgeting tools and templates, visit [TidyFlow on Gumroad](https://gettidyflow.gumroad.com).
...
**Try our free tool:** [50/30/20 Budget Calculator](/tools/budget-calculator/) — enter your income and instantly see how to allocate it across needs, wants, and savings.
