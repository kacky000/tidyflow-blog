---
title: "How to Budget When You Live Paycheck to Paycheck: A Complete Guide"
...
1. **Housing** (rent/mortgage) — you need a roof
2. **Utilities** (electric, water, gas) — you need to live
3. **Food** (groceries, not dining out) — you need to eat
4. **Transportation** (gas, car payment, transit pass) — you need to get to work
...
The [50/30/20 rule](/50-30-20-budget-rule-notion/) may not work exactly as designed when you're paycheck to paycheck, since your needs might exceed 50%. Instead, try a modified version: cover needs first, save even 5-10% if possible, and use whatever remains for wants. As your financial situation improves, gradually move toward the standard percentages.
...
*Take the first step toward breaking the paycheck-to-paycheck cycle. Grab a [free budget template](https://gettidyflow.gumroad.com) and start your paycheck budget today.*
