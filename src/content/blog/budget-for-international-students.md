...
These realities mean you need to budget more carefully, not less. If you're new to budgeting in general, our [guide for college students](/blog/how-to-save-money-college-student/) covers the basics that apply to everyone.
...
1. **Not budgeting for the first month.** Setup costs (deposit, bedding, kitchenware, SIM card) can be 2–3x a normal month.
2. **Ignoring exchange rate changes.** A 10% currency swing on $1,000/month is $100 gone.
3. **Not filing taxes.** Many countries require international students to file tax returns, even with minimal income. You may get a refund.
4. **Overspending on travel.** Exploring is important, but budget for it rather than using credit cards.
5. **Working over visa limits.** This can result in visa revocation. Never risk it for extra cash.
...
Need a simple system to get started? The **[New Life Starter Kit](https://gettidyflow.gumroad.com/l/new-life-starter-kit)** ($3.99) gives you a ready-to-use Notion workspace for tracking expenses, managing goals, and organizing your new life abroad. It's built for fresh starts — exactly what studying in a new country is all about.
