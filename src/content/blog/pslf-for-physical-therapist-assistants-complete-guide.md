---
title: "PSLF for Physical Therapist Assistants (PTA): Complete 2026 Guide"
...
- **Verification Tip**: Check IRS EIN status — community hospitals owned by HCA, Tenet, CHS, Ardent, Prime, or LifePoint are **for-profit and do NOT qualify**, even though they look like "regular hospitals." See our [Memorial Health Savannah HCA PSLF trap analysis](/blog/memorial-health-savannah-hca-pslf-trap/) for how an acquisition can flip an entire workforce out of PSLF overnight.
...
**Documented examples**:
- HCA's Memorial Health Savannah acquisition stopped PSLF for hundreds of clinical staff overnight ([full analysis](/blog/memorial-health-savannah-hca-pslf-trap/))
...
Log in to [StudentAid.gov](https://studentaid.gov). Most PTA students borrowed after 2010, so loans are usually already Direct. If you have older FFEL loans (less common for associate-degree PTAs), consolidate to Direct Consolidation.

### Step 2: Verify your employer's tax status
- Search the [PSLF Employer Search Tool](https://studentaid.gov/pslf/employer-search) by your employer's EIN
- Cross-check with the [IRS Tax Exempt Organization Search](https://apps.irs.gov/app/eos/)
...
**Are PTAs eligible for PSLF if they have only an associate degree?**
Yes. PSLF eligibility depends on the employer and the loan type, not the degree level. Associate-degree PTAs with Direct Loans qualify identically to bachelor's or master's professionals.

**I work at an outpatient clinic owned by a nonprofit hospital — do I qualify?**
Usually yes, if your W-2 is issued by the parent nonprofit hospital and not a separate management company. Confirm by looking at your pay stub.

**What about PTAs in travel therapy?**
Travel therapy companies (Aureus, Cross Country Allied, Med Travelers, Aya Healthcare) are all for-profit. Even if you're placed in a nonprofit hospital, your W-2 employer is the staffing agency, so **PSLF months do not count**.

**Does PRN work at a nonprofit hospital count toward PSLF?**
Only if you average 30+ hours/week of qualifying employment (which can be aggregated across multiple qualifying employers). PRN-only PTAs working <30 hours typically don't qualify on hours alone.

**Should I leave a for-profit SNF for a lower-paying hospital job for PSLF?**
Run the math. With $40,000+ debt, switching to a nonprofit hospital that pays $4,000–$6,000 less per year still nets $15,000–$30,000 of PSLF forgiveness — a clear win. With $20,000 debt or less, the answer depends on your total balance trajectory.

## PSLF Resources for PTAs

- **[PSLF Core Guide](/pslf-loan-forgiveness-guide-for-public-service-workers/)** — Overview for all public service professions
- **[PSLF for Public Health Nurses](/blog/pslf-for-public-health-nurses-complete-guide/)** — Government health department and FQHC PSLF details
- **[PSLF for Librarians](/blog/pslf-for-librarians-complete-guide/)** — School-based PSLF employment framework
- **[Memorial Health Savannah HCA PSLF Trap](/blog/memorial-health-savannah-hca-pslf-trap/)** — Real-world example of an acquisition destroying PSLF eligibility overnight
- **[Free Budget Calculator](/tools/budget-calculator/)** — Calculate your SAVE plan payment vs. standard repayment at PTA salary
- **[Freelancer Expense Tracker ($9.99)](https://gettidyflow.gumroad.com/l/freelancer-expense-tracker)** — Track PRN income across multiple qualifying employers
