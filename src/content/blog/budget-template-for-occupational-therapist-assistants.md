...
Our guide on [budget templates for occupational therapists](/blog/budget-template-for-occupational-therapists/) provides additional strategies for the OT profession that also apply to the OTA career path. For a broader framework used by healthcare workers across settings, the [budget template for healthcare workers](/blog/budget-template-for-healthcare-workers/) covers foundational budgeting principles suited to clinical roles at every salary level.
...
The **[New Life Starter Kit](https://gettidyflow.gumroad.com/l/new-life-starter-kit)** ($3.99) includes a complete Notion-based budgeting system designed for people starting or resetting their financial life. It covers income tracking, expense categories, savings goals, and debt payoff planning — everything you need to manage your OTA salary effectively in one organized template.

**[Get the New Life Starter Kit →](https://gettidyflow.gumroad.com/l/new-life-starter-kit)**
