...
3. Basic groceries
4. Health insurance
5. Car payment/transportation
6. Minimum debt payments
7. Phone
8. Internet
9. Household essentials
10. Gas/commuting costs
11. Emergency fund contribution
...
1. **Replenish buffer** (if below 2-month target)
2. **Tax set-aside** (25-30% of surplus for self-employed earners)
3. **Emergency fund** (until you reach 3-6 months of expenses)
4. **Debt payoff** (above-minimum payments)
5. **Retirement/investing** (SEP IRA, Roth IRA, index funds)
6. **Sinking funds** (car repair, vacation, annual insurance premiums)
7. **Lifestyle upgrades** (only after 1-6 are handled)
...
For a detailed system to organize these expenses digitally, see our guide on [how to track expenses in Notion](/blog/how-to-track-expenses-in-notion/).
...
For freelance-specific strategies including tax management and business expense separation, check our [budget template for freelancers](/blog/budget-template-for-freelancers/).
...
Our [zero-based budgeting guide](/blog/zero-based-budgeting-guide/) explains the full methodology.
...
**[Download the Freelancer Expense Tracker](https://gettidyflow.gumroad.com/l/freelancer-expense-tracker)** — a spreadsheet built for variable income earners. It includes a buffer account tracker, priority expense ranking, surplus allocation calculator, and monthly income comparison — everything you need to implement the baseline budget method immediately.
