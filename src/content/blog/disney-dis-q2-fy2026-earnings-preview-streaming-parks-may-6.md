---
title: "Disney Q2 FY2026 Earnings Preview: Can Streaming Profits Offset Parks Headwinds?"
description: "Disney reports Q2 FY2026 earnings on May 6. Wall Street expects $1.49 EPS and $24.8B revenue. Streaming profits, parks pressure, and sports rights costs are the key themes. Here's what to watch."
pubDate: "2026-05-05"
...
1. **Streaming profitability is the make-or-break metric.** $500M in SVOD operating income would validate Disney's multi-year streaming investment.
2. **Parks headwinds are temporary but real.** Pre-opening costs will fade, but the underlying question is whether consumer spending at parks has peaked.
3. **ESPN rights costs are a known drag** — investors are watching for signs that the standalone ESPN streaming product can offset rising expenses.
4. **EPS is expected to decline YoY** — even a small miss could pressure the stock, while a beat would signal the earnings trough is behind Disney.
5. **Geopolitical risk is a new wildcard.** Monday's UAE-Iran missile incident and oil above $105 could impact consumer discretionary spending and international travel — both directly relevant to Disney's parks business.
